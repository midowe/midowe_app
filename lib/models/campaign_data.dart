...
class CampaignData {
  ...
  factory CampaignData.fromJson(Map<String, dynamic> json, int id,
      Fundraiser fundraiser, List<CampaignImage> images) {
    return CampaignData(
        id: id,
        ...
        target_amount:
            json['target_amount'] == null ? 0.00 : json['target_amount'],
        ...
        thank_you_message:
            json['thank_you_message'] == null ? "" : json['thank_you_message'],
        total_donations:
            json['total_donations'] == null ? 0 : json['total_donations'],
        total_amount:
            json['total_amount'] == null ? 0.00 : json['total_amount'],
        current_balance:
            json['current_balance'] == null ? 0.00 : json['current_balance'],
  ...
  factory CampaignData.fromJson2(Map<String, dynamic> json, int id) {
    return CampaignData(
      id: id,
      description: json['description'],
      title: json['title'],
      ...
      current_balance:
          json['current_balance'] == null ? 0 : json['current_balance'],
      notes: json['notes'] == null ? "" : json['notes'],
      updatedAt: json['updatedAt'] == null ? "" : json['updatedAt'],
      createdAt: json['createdAt'] == null ? "" : json['createdAt'],
      url: json['slug'],
