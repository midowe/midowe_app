...
class FundraiserProvider extends BaseProvider {
  ...
  Future<Fundraiser> fetchFundraiserByCampaignId(int campaignId) async {
    var response = await http.get(Uri.parse("https://cms.dev.midowe.co.mz/api/fundraisers?filters[campaigns]="+campaignId.toString()+"&populate[picture][fields][1]=url"));
    ...
    fundraiser= Fundraiser.fromJsonWithPicture(f['attributes'], f["id"],url);
    }
  }
